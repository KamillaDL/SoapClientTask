 ...
 * 
 */
@WebServiceClient(name = "BookServiceImplService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/bookservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICEIMPLSERVICE_QNAME = new QName("http://services/", "BookServiceImplService");
    ...
    public BookService getBookServiceImplPort() {
        return super.getPort(new QName("http://services/", "BookServiceImplPort"), BookService.class);
    }
    ...
    public BookService getBookServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "BookServiceImplPort"), BookService.class, features);
    }
